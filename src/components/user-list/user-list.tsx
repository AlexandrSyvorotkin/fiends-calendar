...
const UserList = ({
  ...
  return (
    <div className="hidden md:flex w-72 h-72 flex-col bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-200/50 overflow-hidden fade-in-up">
